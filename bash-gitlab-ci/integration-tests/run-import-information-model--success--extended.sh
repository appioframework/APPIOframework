...
VAR_COMMANDS[0]="appio import information-model -n my-app -p model.xml -t types.bsd"
VAR_COMMANDS[1]="appio import information-model -n my-app -p model.xml --types types.bsd"
VAR_COMMANDS[2]="appio import information-model -n my-app --path model.xml -t types.bsd"
VAR_COMMANDS[3]="appio import information-model -n my-app --path model.xml --types types.bsd"
VAR_COMMANDS[4]="appio import information-model --name my-app -p model.xml -t types.bsd"
VAR_COMMANDS[5]="appio import information-model --name my-app -p model.xml --types types.bsd"
VAR_COMMANDS[6]="appio import information-model --name my-app --path model.xml -t types.bsd"
VAR_COMMANDS[7]="appio import information-model --name my-app --path model.xml --types types.bsd"
