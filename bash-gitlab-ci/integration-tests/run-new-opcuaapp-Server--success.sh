...
VAR_COMMANDS[0]="oppo new opcuaapp -n my-app -t Server"
VAR_COMMANDS[1]="oppo new opcuaapp -n my-app --type Server"
VAR_COMMANDS[2]="oppo new opcuaapp --name my-app -t Server"
VAR_COMMANDS[3]="oppo new opcuaapp --name my-app --type Server"
