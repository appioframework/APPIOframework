...
VAR_COMMANDS[0]="oppo import certificate -n my-app --cert mycert.der --key mykey.der --server"
VAR_COMMANDS[1]="oppo import certificate -n my-app --cert mycert.pem --key mykey.der --server"
VAR_COMMANDS[2]="oppo import certificate  --server -n my-app --cert mycert.pem --key mykey.key"
VAR_COMMANDS[3]="oppo import certificate -n my-app  --server --cert mycert.crt --certificate-format pem --key mykey.key"
VAR_COMMANDS[4]="oppo import certificate -n my-app --cert mycert.crt  --server --certificate-format PEM --key mykey.key"
