...
@pytest.mark.parametrize('case, command, app_name', [
    ['1_sample', 'appio import information-model -n my-app -s', 'my-app'],  # noqa: #501
    ['2_sample', 'appio import information-model -n my-app --sample', 'my-app'],  # noqa: #501
    ['3_sample', 'appio import information-model --name my-app -s', 'my-app'],  # noqa: #501
    ['4_sample', 'appio import information-model --name my-app --sample', 'my-app'],  # noqa: #501
])
def test_that_appio_import_information_model_is_succeeding_when_importing_sample_file(host, case, command, app_name):  # noqa: #501
    # prepare
    test_dir_path = prepare_provide_test_directory(host, case)
...
def test_that_appio_import_information_model_is_failing_when_importing_model_and_types_file(host, case, command, app_name):  # noqa: #501
    # prepare
    test_dir_path = prepare_provide_test_directory(host, case)
