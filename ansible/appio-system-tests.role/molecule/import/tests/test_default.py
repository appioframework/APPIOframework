...
@pytest.mark.parametrize('case, command, app_name', [
    ...
    ['4f', 'appio import information-model -n my-app --path model.xml --types types.bsd', 'my-app'],  # noqa: #501
    ['5f', 'appio import information-model --name my-app -p model.xml -t types.bsd', 'my-app'],  # noqa: #501
    ['6f', 'appio import information-model --name my-app -p model.xml --types types.bsd', 'my-app'],  # noqa: #501
    ['7f', 'appio import information-model --name my-app --path model.xml -t types.bsd', 'my-app'],  # noqa: #501
    ['8f', 'appio import information-model --name my-app --path model.xml --types types.bsd', 'my-app'],  # noqa: #501
])
