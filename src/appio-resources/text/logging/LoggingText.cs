...
namespace Appio.Resources.text.logging
{
    public static class LoggingText
    {
        ...
        public const string AppioHelpCalled = "Help <command> called";
        public const string AppioHelpForNewCommandCalled = "Help for new <command> called";
        public const string AppioHelpForBuildCommandCalled = "Help for build <command> called";
        public const string AppioHelpForCleanCommandCalled = "Help for clean <command> called";
        ...
        public const string AppioHelpForDeployCommandCalled = "Help for deploy <command> called";
		...
		public const string AppioHelpForGenerateCommand = "Help for generate <command> called";
		public const string GenerateInformationModelFailureCouldntDeserliazeOpcuaapp = "Couldn't deserialize appioproj file!";
		...
		public const string GenerateInformationModelInvalidModelsList = "Generate information model failure, provided model list contains duplications or misses some models!";
		public const string GenerateInformationModelCircularDependency = "Generate information model failure, models refer to each other in endless loop!";
		...
		public const string SlnAppioslnFileNotFound	= "Missing solution file!";
		public const string SlnCouldntDeserliazeSln	= "Couldn't deserialize sln file!";
		public const string AppioHelpForSlnCommand	= "Help for sln <command> called";
		// sln add command
		public const string SlnAddSuccess				    = "Opcuaapp project file successfully added to sln.";
        public const string SlnAddAppioprojFileNotFound		= "Missing project file!";
        public const string SlnAddCouldntDeserliazeOpcuaapp	= "Couldn't deserialize appioproj file!";
		...
		public const string SlnRemoveAppioprojNameEmpty	= "Empty project name!";
		...
		public const string AppioHelpForImportInformationModel = "Help for import <command> called";

		// reference common
		public const string ReferenceUnknownCommandParam = "Unknown reference command parameter!";
		public const string ReferenceClientAppioprojFileNotFound = "Client's appioproj file not found!";
		public const string ReferenceCouldntDeserliazeClient = "Couldn't deserialize client file!";
		public const string AppioHelpForReferenceCommand = "Help for reference <command> called";

		// reference add command
		public const string ReferenceAddSuccess = "Server reference successfully added to client project file.";
		public const string ReferenceAddServerAppioprojFileNotFound = "Server's appioproj file not found!";
