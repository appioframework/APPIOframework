namespace Appio.Resources.text.help
{
    public static class HelpTextValues
    {
        ...
        public const string HelpStartDocuLink = "For a more detailed documentation visit https://madeupwebsite.appio/help.html";
        ...
        public const string HelpStartOpcuaappDescription = "an OPC UA server/client Instance generated by appio";
        ...
        //Build command
        public const string BuildFirstLine = "Build an appio project.";
        public const string BuildCallDescription = "appio build <Options>";

        //Clean command
        public const string CleanFirstLine = "Cleans an appio project. Removes temporary files and folders.";
        public const string CleanCallDescription = "appio clean <Options>";

        //Publish command
        public const string PublishFirstLine = "Publishes an appio project for deployment.";
		...
		//Import command
		public const string ImportFirstLine = "Imports files to appio project. Depends on used argument server certificates or information models will be imported to the projct.";
		...
		//New command
		public const string NewFirstLine = "Creates a new appio project or solution.";
		...
		//Generate command
		public const string GenerateCommand = "Generates artifacts into existing appio project.";
