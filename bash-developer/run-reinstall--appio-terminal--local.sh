...
/bin/bash bash-ci/run-dpkg-build--open62541--v0.3.0.sh
...
/bin/bash bash-developer/util-elevate.sh root bash-ci/run-dpkg-remove--open62541--v0.3.0.sh
echo "Removing open62541--v0.3.0 ... done"

echo "Installing open62541--v0.3.0 ..."
/bin/bash bash-developer/util-elevate.sh root bash-ci/run-dpkg-install--open62541--v0.3.0.sh
